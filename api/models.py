...
class ScrapeRequest(BaseModel):
    ...
    amazon_urls: Optional[List[HttpUrl]] = Field(default=[], description="List of Amazon product URLs to scrape")
    amazon_names: Optional[List[str]] = Field(default=[], description="Custom names for Amazon products (must match order of URLs)")
    include_static: bool = Field(default=True, description="Whether to include static data")
    snapshot_name: Optional[str] = Field(default="API scrape", description="Name for database snapshot")
